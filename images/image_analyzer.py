...
def main():
    # Defaults are resolved relative to this script so the modality runs the
    ...
    parser.add_argument("--input", default=str(script_dir / "sample_images"),
                        help="Folder of input images (place your .jpg/.png files here)")
    parser.add_argument("--output", default=str(script_dir / "image_report.csv"),
                        help="Output CSV path")
    parser.add_argument("--weights", default="yolov8n.pt",
                        help="YOLOv8 pretrained weights (auto-downloaded if absent)")
